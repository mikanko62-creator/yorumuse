...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    id: "free_tier",
    name: "Free User",
    tagline: "Free access to watch trailers and public previews.",
    price: 0,
    currency: "EUR",
    interval: "month",
    features: [
      "Watch all trailers and public previews",
      "Read community forum discussions",
      "Free account registration at no cost",
  ...
  },
  {
    id: "member_monthly",
    name: "Subscriber",
    tagline: "Full unlimited access to all videos and manhwa serial chapters.",
    price: 9.99,
    currency: "EUR",
    interval: "month",
    popular: true,
    badge: "SUBSCRIPTION",
    features: [
      "Unlimited access to all full manhwa episodes & chapters",
      "Stream all video series without restrictions",
      "Full participation in community forums & discussions",
      "PayPal & European Credit Card payment support",
