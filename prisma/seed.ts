  ...
  for (const item of MOCK_CONTENT) {
    ...
    const chapter1 = await prisma.chapter.upsert({
      ...
      create: {
        ...
        chapterNumber: 1,
        title: `Chapter 1: The Overture`,
        description: `A captivating opening chapter that introduces the narrative themes and visual atmosphere of this production.`,
        videoUrl: item.videoUrl || item.trailer,
        duration: item.duration || "42 min",
        thumbnail: item.thumbnail,
        published: true,
    ...
    if (item.featured) {
      const chapter2 = await prisma.chapter.upsert({
        ...
        create: {
          ...
          chapterNumber: 2,
          title: `Chapter 2: Midnight Reverie`,
          description: `The sequel chapter delving deeper into emotional tension and intimate noir cinematography.`,
          videoUrl: item.videoUrl || item.trailer,
          duration: "38 min",
          thumbnail: item.thumbnail,
          published: true,
      ...
      await prisma.chapterComment.upsert({
        ...
        create: {
          ...
          authorId: member.id,
          content: "The ambient music transition in the middle of chapter two is remarkably serene and elegant. Truly love the visual detail.",
          status: "PUBLISHED",
        },
      });
    }
    ...
    await prisma.chapterComment.upsert({
      ...
      create: {
        ...
        authorId: member.id,
        content: "The cinematography in Chapter 1 is truly breathtaking. Natural lighting and color gradation feel exceptionally classy.",
        status: "PUBLISHED",
      },
    });
  }
